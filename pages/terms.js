...
const terms = () => {
  return (
    <div className={''}>
      ...
      <p>
        TABLE OF CONTENTS 1. AGREEMENT TO TERMS 2. INTELLECTUAL PROPERTY RIGHTS
        3. USER REPRESENTATIONS 4. USER REGISTRATION 5. PROHIBITED ACTIVITIES 6.
        USER GENERATED CONTRIBUTIONS 7. CONTRIBUTION LICENSE 8. GUIDELINES FOR
        REVIEWS 9. SOCIAL MEDIA 10. SUBMISSIONS 11. THIRD-PARTY WEBSITE AND
        CONTENT 12. SITE MANAGEMENT 13. COPYRIGHT INFRINGEMENTS 14 TERM AND
        TERMINATION 15 MODIFICATIONS AND INTERRUPTIONS 16 GOVERNING LAW 17.
        DISPUTE RESOLUTION 18. CORRECTIONS 19. DISCLAIMER 20. LIMITATIONS OF
        LIABILITY 21. INDEMNIFICATION 22. USER DATA 23. ELECTRONIC
        COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 24. MISCELLANEOUS 25.
        CONTACT US agement 1. AGREEMENT TO TERMS These Terms of Use constitute a
        legally binding agreement made between you, whether personally or on
        behalf of an entity ("you") and ninepointer ("Company" "we," "us," or
        "our"). concerning your access to and use of the ninepointer.com website
        ...
        registered office at Jaipur, Rajasthan, Jaipur, Rajasthan 302001. You
        ...
        applicable. All users who are minors in the jurisdiction in which they
        reside (generally under the age of 18) must have the permission of, and
        be directly supervised by their parent or guardian to use the Site. If
        you are a minor, you must have your parent or guardian read and agree to
        these Terms of Use prior to you using the Site. 2. INTELLECTUAL PROPERTY
        RIGHTS Unless otherwise indicated, the Site is our proprietary property
        ...
        granted to you in and to the Site, the Content and the Marks. 3. USER
        REPRESENTATIONS By using the Site, you represent and warrant that: (1)
        ...
        all current or future use of the Site (or any portion thereof). 4. USER
        REGISTRATION You may be required to register with the Site. You agree to
        ...
        objectionable. 5. PROHIBITED ACTIVITIES You may not access or use the
        ...
        services or submit false reports of abuse or misconduct. Use the Site in
        a manner inconsistent with any applicable laws or regulations. Engage in
        ...
        commercial enterprise. . Sell or otherwise transfer your profile. •
        Replicating resources or data. 6. USER GENERATED CONTRIBUTIONS The Site
        ...
        to use the Site. 7. CONTRIBUTION LICENSE By posting your Contributions
        to any part of the Site or making Contributions accessible to the Site
        ...
        Contributions We have the night, in our sole and absolute discretion,
        ...
        monitor your Contributions. 8. GUIDELINES FOR REVIEWS We may provide you
        areas on the Site to leave reviews or ratings: When posting a review you
        ...
        hate language (3) your reviews should not contain discriminatory
        references based on religion, race, gender, national ongin, age, mantal
        status sexual orientation or disability (4) your reviews should not
        contain references to illegal activity (5) you should not be affiliated
        with competitors if posting negative reviews (6) you should not make any
        conclusions as to the legality of conduct (7) you may not post any false
        or misleading. statements and (B) you may not organize a campaign
      ...
      <p>
        ...
        any review. By posting a review, you hereby grant to us a perpetual, non
        ...
        relating to reviews. 9. SOCIAL MEDIA As part of the functionality of the
        ...
        obtained through such Third-Party Account, except the usemame and
        ...
        via the Site) links to other websites (Third-Party Websites") as well as
        ...
        contact with Third-Party Websites 12. SITE MANAGEMENT We reserve the
        night but not the obligation, to: (1) monitor the Site for violations of
        ...
        of the Site. 13. COPYRIGHT INFRINGEMENTS We respect the intellectual
        property rights of others. If you believe that any material available on
        or through the Site infringes upon any copyright you owne r control
        ...
        first contacting an attorney 14. TERM AND TERMINATION These Terms of Use
        ...
        the Site. We cannot guarantee the Site will be available at all times.
        We may experience hardware software, or other problems or need to
        perform maintenance related to the Ste resulting in interruptions delays
        or errors: We reserve the right to change revise, update, suspend,
        discontinue or otherwise modify the Site at any time or for any reason
        without notice to you You agree that we have no vability whatsoever for
        any loss damage or inconvenience caused by your inability to access or
        use the Str during any downtime or discontinuance of the Site Nothing in
        ...
        connection therewith. 16. GOVERNING LAW These Terms shall be governed by
        and defined following the laws of India. ninepointer and yourself
        ...
        these terms. 17. DISPUTE RESOLUTION You agree to irrevocably submit all
        disputes related to Terms or the relationship established by this
        Agreement to the jurisdiction of the India courts. ninepointer shall
        also maintain the right to bring proceedings as to the substance of the
        matter in the courts of the country where you reside or, if these Terms
        are entered into in the course of your trade or profession, the state of
        your principal place of business. 18. CORRECTIONS There may be
        ...
        the Information on the Site at any time, without prior notice. 19.
        DISCLAIMER THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU
        ...
        JUDGMENT AND EXERCISE CAUTION WHERE APPROPRIATE 20. LIMITATIONS OF
        ...
        LIMITATIONS MAY NOT APPLY TO YOU AND YOU MAY HAVE ADDITIONAL RIGHTS. 21.
        ...
        of it. 22. USER DATA We will maintain certain data that you transmit to
        ...
        23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES Visiting the
